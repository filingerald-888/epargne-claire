...
export const products: ProductComparison[] = [
  ...
  },
  {
    ...
    fiscalite: "Exonéré d'impôt sur les gains après 5 ans (prélèvements sociaux : 18,6 %)",
    liquidite: 'Retrait avant 5 ans = clôture automatique ; après 5 ans = retrait partiel possible',
  ...
  },
  {
    ...
    fiscalite: 'Versements déductibles du revenu imposable (prélèvements sociaux : 18,6 % à la sortie ; non déductible après 70 ans depuis 2026)',
  ...
  },
  {
    ...
    fiscalite: 'Revenus fonciers imposables au barème + prélèvements sociaux (17,2 %, inchangé en 2026)',
